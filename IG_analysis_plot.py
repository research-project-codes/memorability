...
Usage:
- To save the attributions: python IG_attributes.py --save
- To display the attributions: python IG_attributes.py --display
- To do both: python IG_attributes.py --save --display
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="best_gru_model.pth", help='Path to the GRU model')
